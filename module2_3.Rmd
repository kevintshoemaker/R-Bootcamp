...
This is the first of the modules that really go beyond the basics. Now we start with our "whirlwhind" tour of more advanced things you can do in R. 
...
### Goal: correlations between all gene pairs
...
Type the following in R and watch the CPU Usage History graph:
...
The opposite of parallel processing is "sequential processing". Let's test a sequential version of this:
