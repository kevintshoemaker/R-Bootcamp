...
![](funcmach.png){width=25%,height=25%}
...
Note that a "tibble" is the same thing as a data frame, just with a few tweaks to make it work better in the tidyverse. We will primarily work with tibble data frames in this workshop.
