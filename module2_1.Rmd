...
Before we move on, the "car" package (_c_ompanion to _a_pplied _r_egression) gives us an example of the things we can do with R packages. Here we will make our own interactive 3d plot! (example from "prelude in R").
