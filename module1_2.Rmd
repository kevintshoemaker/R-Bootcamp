...
What's yours? Usually the default working directory is your "Documents" folder. Since you should already be working in an RStudio Project, your working directory will automatically be set as your project directory (directory that contains the .Rproj file for your project).
...
1. No spaces within object names (same for column names in data files) -- use dot or underscore instead!          
...
## Basic data checking
As you've already seen, data structures include vectors, matrices, arrays, data frames, and lists.
...
## More practice with data processing!
...
NOTE: newer versions of R read in character data as character data, so this is no longer as big a problem!
