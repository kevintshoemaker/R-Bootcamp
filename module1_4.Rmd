...
station_mean2 <- tidy_clim_data %>%
  ...
  mutate(across(c(TMaxF, TMinF), C=(.-32)*5/9)) %>% 
...
- Create a tibble dataframe using the code below and make it tidy. Do you need to pivot_longer or pivot_wider? What are the variables? what are the observations?
